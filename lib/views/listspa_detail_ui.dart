...
class ListspaDetailUI extends StatefulWidget {
  @override
  String name = '';
  String website = '';
  String facebook = '';
  ...
  _ListspaDetailUIState createState() => _ListspaDetailUIState();
}

class _ListspaDetailUIState extends State<ListspaDetailUI> {
